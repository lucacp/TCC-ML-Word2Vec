...
def kfold_resultados(data_file,nome):
    ...
    gera_pickle('Vec-Concat_-pca_n_' + data_file, targets, 'Pca-n-' + nome + ".pkl")
    gera_pickle('Vec-Concat_-pca_w_' + data_file, targets, 'Pca-w-' + nome + ".pkl")
    gera_pickle('Vec-Concat_-gaussi_'+ data_file, targets, 'Gauss-' + nome + ".pkl")
    gera_pickle('Vec-Concat_-sparse_'+ data_file, targets, 'Spars-' + nome + ".pkl")

    X1, y = carrega_pickle('Pca-n-' + nome + ".pkl")
    X2, y = carrega_pickle('Pca-w-' + nome + ".pkl")
    X3, y = carrega_pickle('Gauss-' + nome + ".pkl")
    X4, y = carrega_pickle('Spars-' + nome + ".pkl")
    ...
    arq1 = open('Result-pca_n_'+data_file,'w')
    arq2 = open('Result-pca_w_'+data_file,'w')
    arq3 = open('Result-gauss_'+data_file,'w')
    arq4 = open('Result-spars_'+data_file,'w')
