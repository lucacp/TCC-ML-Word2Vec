...
def kfold_resultados(data_file,nome):
    ...
    gera_pickle('Vec-SomaConcat-pca_n_' + data_file, targets, 'SCPca-n-' + nome + ".pkl")
    gera_pickle('Vec-SomaConcat-pca_w_' + data_file, targets, 'SCPca-w-' + nome + ".pkl")
    gera_pickle('Vec-SomaConcat-gaussi_'+ data_file, targets, 'SCGauss-' + nome + ".pkl")
    gera_pickle('Vec-SomaConcat-sparse_'+ data_file, targets, 'SCSpars-' + nome + ".pkl")

    X1, y = carrega_pickle('SCPca-n-' + nome + ".pkl")
    X2, y = carrega_pickle('SCPca-w-' + nome + ".pkl")
    X3, y = carrega_pickle('SCGauss-' + nome + ".pkl")
    X4, y = carrega_pickle('SCSpars-' + nome + ".pkl")
    ...
    #print('3')
    arq1 = open('Result-SomaConcat-pca_n_'+data_file,'w')
    arq2 = open('Result-SomaConcat-pca_w_'+data_file,'w')
    arq3 = open('Result-SomaConcat-gauss_'+data_file,'w')
    arq4 = open('Result-SomaConcat-spars_'+data_file,'w')
