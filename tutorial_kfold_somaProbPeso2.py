...
arqs=tex.split('\n')
for i in arqs:
    print('soma_'+i+"-2-peso1.txt")
    l='soma_'+i+"-2-peso1.txt"
    kfold_resultados(data_file=l,nome=i)
    print('soma_'+i+"-2-peso1-st.txt")
    l='soma_'+i+"-2-peso1-st.txt"
    kfold_resultados(data_file=l,nome=i)
    print('soma_'+i+"-2-peso2.txt")
    l='soma_'+i+"-2-peso2.txt"
    kfold_resultados(data_file=l,nome=i)
    print('soma_'+i+"-2-peso2-st.txt")
    l='soma_'+i+"-2-peso2-st.txt"
    kfold_resultados(data_file=l,nome=i)
