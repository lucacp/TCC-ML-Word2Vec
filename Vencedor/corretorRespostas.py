...
def kfold_resultados(data_file,nome,file2,dest):
    ...
    svm1 = SGDClassifier(loss='squared_hinge',penalty='l1',        alpha=0.001, learning_rate='constant',eta0=0.1)
    svm2 = SGDClassifier(loss='squared_hinge',penalty='l1',        alpha=0.001, learning_rate='optimal', eta0=0.01)
    svm3 = SGDClassifier(loss='log',          penalty='l2',        alpha=0.0001,learning_rate='optimal', eta0=0.01)
    svm4 = SGDClassifier(loss='squared_hinge',penalty='none',      alpha=0.01,  learning_rate='optimal', eta0=0.01)
    svm5 = SGDClassifier(loss='squared_hinge',penalty='elasticnet',alpha=0.01,  learning_rate='optimal', eta0=0.01)
#    svm6 = SGDClassifier(loss='perceptron',   penalty='elasticnet',alpha=0.0001,learning_rate='optimal', eta0=0.01)
    svm7 = SGDClassifier(loss='squared_hinge',penalty='l1',        alpha=0.0001,learning_rate='constant',eta0=0.1)
    svm8 = SGDClassifier(loss='squared_hinge',penalty='none',      alpha=0.0001,learning_rate='optimal', eta0=0.01)
    p1 = svm1.fit(X, y)
    p2 = svm2.fit(X, y)
    p3 = svm3.fit(X, y)
    p4 = svm4.fit(X, y)
 ...
 #   p6 = svm6.fit(X, y)
    p7 = svm7.fit(X, y)
    p8 = svm8.fit(X, y)
    print('SGDClassifier(loss=squared_hinge,penalty=l1,alpha=0.001,learning_rate=constant,eta0=0.1)',file=arq2)
    print(p1.predict(X2),file=arq2)
    print('SGDClassifier(loss=squared_hinge,penalty=l1,alpha=0.001,learning_rate=optimal,eta0=0.01)',file=arq2)
    print(p2.predict(X2),file=arq2)
    print('SGDClassifier(loss=log,penalty=l2,alpha=0.0001,learning_rate=optimal,eta0=0.01)',file=arq2)
    print(p3.predict(X2),file=arq2)
    print('SGDClassifier(loss=squared_hinge,penalty=none,alpha=0.01,learning_rate=optimal,eta0=0.01)',file=arq2)
    print(p4.predict(X2),file=arq2)
    print('SGDClassifier(loss=squared_hinge,penalty=elasticnet,alpha=0.01,learning_rate=optimal,eta0=0.01)',file=arq2)
    print(p5.predict(X2),file=arq2)
  #  print('SGDClassifier(loss=perceptron,penalty=elasticnet,alpha=0.0001,learning_rate=optimal,eta0=0.01)',file=arq2)
  #  print(p6.predict(X2),file=arq2)
    print('SGDClassifier(loss=squared_hinge,penalty=l1,alpha=0.0001,learning_rate=constant,eta0=0.1)',file=arq2)
    print(p7.predict(X2),file=arq2)
    print('SGDClassifier(loss=squared_hinge,penalty=none,alpha=0.0001,learning_rate=optimal,eta0=0.01)',file=arq2)
    print(p8.predict(X2),file=arq2)
    #print(p1.score(X,y))
    #print(p2.score(X,y))
    #print(p3.score(X,y))
    #print(p4.score(X,y))
