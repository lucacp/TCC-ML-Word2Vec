...
l=[    "soma__init-0.05_const-bias_2lr_hid125_proj0_vocab50000_batch1(20)_steps77_maxNrm1.0_sgd-1.0_dec-12-0.5_dropout0.4vectores.txt",
       "soma__init-0.05_const-bias_2lr_hid125_proj0_vocab50000_batch1(20)_steps77_maxNrm1.0_sgd-1.0_dec-12-0.5_dropout0.5vectores.txt",
       "soma__init-0.05_const-bias_2lr_hid125_proj0_vocab50000_batch1(30)_steps77_maxNrm1.0_sgd-1.0_dec-12-0.5_dropout0.4vectores.txt",
       "soma__init-0.05_const-bias_2lr_hid125_proj0_vocab50000_batch1(30)_steps77_maxNrm1.0_sgd-1.0_dec-12-0.5_dropout0.5vectores.txt",
       "soma__init-0.05_const-bias_2lr_hid125_proj0_vocab50000_batch1(30)_steps77_maxNrm1.0_sgd-1.0_dec-12-0.5_dropout0.6vectores.txt"]
for i in l:
    print(i)
    kfold_resultados(data_file=i,nome='rnn')
