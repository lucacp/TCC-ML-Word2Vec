...
def kfold_resultados(data_file,nome,file2,dest):
    ...
    svm1 = SVC(kernel='sigmoid',C=1000,gamma=1e-2,degree=2,coef0=0.0)
    svm2 = SVC(kernel='sigmoid',C=1000,gamma=1e-2,degree=2,coef0=0.1)
    svm3 = SVC(kernel='sigmoid',C=1000,gamma=1e-2,degree=2,coef0=0.01)
    svm4 = SVC(kernel='sigmoid',C=1000,gamma=1e-2,degree=3,coef0=0.0)
    svm5 = SVC(kernel='sigmoid',C=1000,gamma=1e-2,degree=3,coef0=0.1)
    svm6 = SVC(kernel='sigmoid',C=1000,gamma=1e-2,degree=3,coef0=0.01)
    p1 = svm1.fit(X, y)
    p2 = svm2.fit(X, y)
    p3 = svm3.fit(X, y)
    p4 = svm4.fit(X, y)
    p5 = svm5.fit(X, y)
    p6 = svm6.fit(X, y)
    print('SVC(kernel=sigmoid,C=1000,gamma=1e-2,degree=2,coef0=0.0)',file=arq2)
    print(p1.predict(X2),file=arq2)
    print('SVC(kernel=sigmoid,C=1000,gamma=1e-2,degree=2,coef0=0.1)',file=arq2)
    print(p2.predict(X2),file=arq2)
    print('SVC(kernel=sigmoid,C=1000,gamma=1e-2,degree=2,coef0=0.01)',file=arq2)
    print(p3.predict(X2),file=arq2)
    print('SVC(kernel=sigmoid,C=1000,gamma=1e-2,degree=3,coef0=0.0)',file=arq2)
    print(p4.predict(X2),file=arq2)
    print('SVC(kernel=sigmoid,C=1000,gamma=1e-2,degree=3,coef0=0.1)',file=arq2)
    print(p5.predict(X2),file=arq2)
    print('SVC(kernel=sigmoid,C=1000,gamma=1e-2,degree=3,coef0=0.01)',file=arq2)
...
#                        print(np.int32(cnt[one]))
                    ...
                    print('Palavra: "'+one+'" na linha: '+str(num)+' nao foi encontrada. Verifique se foi escrita corretamente.')
            else:
                fora = fora + 1
#                print("..."+one+"... stw: "+str(num))
            #firs = firs+1
